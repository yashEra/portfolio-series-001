            ...
            <div className="container relative">
                <div className="md:flex justify-center">
                    <div className="lg:w-3/5">
                        <h5 className="md:text-3xl text-2xl md:leading-normal leading-normal font-medium">{data?.title}</h5>
                        ...
                        <div className="flex mt-5">
                            <span className="font-medium"><i className="mdi mdi-calendar-blank-outline me-2"></i>{data?.date}</span>
                            <span className="ms-3 font-medium"><i className="mdi mdi-clock-outline me-2"></i>5 min read</span>
                        </div>

                        <div className="flex items-center mt-5">
                            <Image src={data?.image1} width={48} height={48} className="h-12 w-12 rounded-xl" alt=""/>

                            <div className="ms-2">
                                <Link href="" className="font-medium block hover:text-orange-500">{data?.athor}</Link>
                ...
                <div className="md:flex justify-center mt-6">
                    <div className="lg:w-full">
                        <div className="relative">
                            <Image src={data?.image} width={0} height={0} sizes="100vw" style={{width:"100%", height:"auto"}}  className="rounded-xl shadow-md dark:shadow-gray-800" alt=""/>
