                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-[30px]">
                    <div className="text-center px-6">
                        ...
                        <div className="content mt-7">
                            ...
                            <div className="mt-5">
                                <Link href="tel:+152534-468-854" className="text-orange-500 hover:text-orange-500 after:bg-orange-500 transition duration-500">+152 534-468-854</Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="text-center px-6">
                        ...
                        <div className="content mt-7">
                            ...
                            <div className="mt-5">
                                <Link href="mailto:contact@example.com" className="text-orange-500 hover:text-orange-500 after:bg-orange-500 transition duration-500">contact@example.com</Link>
                            </div>
                        </div>
                    </div>
