...
export default function Switcher(){
    ...
    return(
        ...
        <Link href="#" onClick={scrollToTop}  id="back-to-top" className={`${scrollTop ? 'back-to-top fixed flex items-center justify-center text-lg rounded-xl z-10 bottom-5 end-5 h-8 w-8 text-center bg-orange-500 hover:bg-orange-600 text-white leading-9 duration-500':'none'} `}><AiOutlineArrowUp className="h-[14px] w-[14px]" /></Link>
        </>
    )
}