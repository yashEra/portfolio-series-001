      ...
      <div className="container relative md:mt-24 mt-16">
        {title === false ? (
          ...
          <div className="grid grid-cols-1 pb-6 text-center">
            ...
            <p className="text-slate-400 dark:text-white/60 max-w-xl mx-auto">
              ...
              that span from conceptual design to project completion.
            </p>
          </div>
        )}
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-6 gap-6">
          {featuresData.map((item, index) => {
            return (
              <div
                className="group relative lg:px-6 transition duration-500 ease-in-out rounded-xl overflow-hidden text-center"
                key={index}
              >
