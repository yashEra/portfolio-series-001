                ...
                <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-6">
                    ...
                    <div className="lg:col-span-7 md:col-span-6">
                        <div className="lg:ms-5">
                            ...
                            <p className="text-slate-400 dark:text-white/60 max-w-xl">Obviously Im a Web Designer. Experienced with all stages of the development cycle for dynamic web projects.</p>
