...
export default function DetailsFour(){
    const image = ["/images/portfolio/16.jpg","/images/portfolio/17.jpg","/images/portfolio/18.jpg"]
    return(
        <>
         <Navlight/>
                            ...
                            {image.map((item,index)=>{
                                return(
                                    <div className="tiny-slide" key={index}>
                                        <div className="m-2">
                                            <Image src={item} width={0} height={0} sizes="100vw" style={{width:"100%", height:"auto"}} className="rounded-xl shadow dark:shadow-gray-800" alt=""/>
                                        </div>
                                    </div>
                                )
                            })}
